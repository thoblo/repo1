...
studentenpopkoor_tillburg <- get_playlist_audio_features('41ibLRl4eo3IUgAo6kkGqP', '41ibLRl4eo3IUgAo6kkGqP')
Firma_Vocaal <- get_playlist_audio_features('5Gdoi0unbwFVUR0YMHKRCV', '5Gdoi0unbwFVUR0YMHKRCV')
Popolo <- get_playlist_audio_features('02F2tqTr7CSqHTrMwQRANP', '02F2tqTr7CSqHTrMwQRANP')
Vocal_Essen <- get_playlist_audio_features('65zAD6mOKtIFYqiwuIltOK', '65zAD6mOKtIFYqiwuIltOK')
Plica <- get_playlist_audio_features('0dcdXmiSoZsqdKHfZ3Uqvf', '0dcdXmiSoZsqdKHfZ3Uqvf')
UCK_Utrecht <- get_playlist_audio_features('65AdHWpI0E1GNvhFc89Do5', '65AdHWpI0E1GNvhFc89Do5')
...
top_100_60s <- 
  ...
  bind_rows(top_100_over_1967 %>% mutate(playlist = "1967")) %>%
  bind_rows(top_100_over_1968 %>% mutate(playlist = "1968")) %>%
  bind_rows(top_100_over_1969 %>% mutate(playlist = "1969"))
